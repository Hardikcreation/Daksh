...
const sections = [
  { id: "background", label: "1. BACKGROUND AND KEY INFORMATION" },
  { id: "personal-data", label: "2. PERSONAL DATA THAT WE COLLECT" },
  { id: "collection", label: "3. HOW DO WE COLLECT PERSONAL DATA?" },
  { id: "usage", label: "4. HOW DO WE USE YOUR PERSONAL DATA?" },
  { id: "cookies", label: "5. COOKIES" },
  { id: "disclosures", label: "6. DISCLOSURES OF YOUR PERSONAL DATA" },
  { id: "rights", label: "7. YOUR RIGHTS IN RELATION TO YOUR PERSONAL DATA" },
  { id: "deletion", label: "8. DELETION OF ACCOUNT AND PERSONAL DATA" },
  { id: "transfers", label: "9. TRANSFERS OF YOUR PERSONAL DATA" },
  { id: "security", label: "10. DATA SECURITY" },
  { id: "retention", label: "11. DATA RETENTION" },
  { id: "business", label: "12. BUSINESS TRANSITIONS" },
  { id: "ugc", label: "13. USER GENERATED CONTENT" },
];

const sectionContent = {
  background: `1. BACKGROUND AND KEY INFORMATION
...
`,
  "personal-data": `2. PERSONAL DATA THAT WE COLLECT
...
`,
  collection: `3. HOW DO WE COLLECT PERSONAL DATA?
...
`,
  usage: `4. HOW DO WE USE YOUR PERSONAL DATA?
...
`,
  disclosures: `6. DISCLOSURES OF YOUR PERSONAL DATA
...
(ii) Internal third parties, which are other companies within the Daksh Call Karigar group of companies.
...
`,
  rights: `7. YOUR RIGHTS IN RELATION TO YOUR PERSONAL DATA
(a) Access and Updating your Personal Data: You hereby warrant that all personal data that you provide us with is accurate, up-to-date, and true. When you use our Services, we make best efforts to provide you with the ability to access and correct inaccurate or deficient data, subject to any legal requirements. You can request Daksh Call Karigar for a copy of your personal data by sending an email to daksh@callKarigar.com. Daksh Call Karigar may take up to 7 (seven) working days respond to such request.
...
`,
  deletion: `8. DELETION OF ACCOUNT AND PERSONAL DATA
(a) Notwithstanding anything contained in the Terms, you may delete your account as well as your personal data stored with Daksh Call Karigar by sending an email to daksh@callKarigar.com. Daksh Call Karigar may take up to 7 (seven) working days to process your request. Once your account is deleted, you will lose access to all Services. For avoidance of doubt, it is hereby clarified that all data with respect to transactions performed by you on the Platform will be retained in accordance with applicable law.
`,
  transfers: `9. TRANSFERS OF YOUR PERSONAL DATA
...
`,
  business: `12. BUSINESS TRANSITIONS
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row pt-10 pb-20 px-4 sm:px-8">
        ...
        <aside className="md:w-1/4 mb-8 md:mb-0 md:pr-8 sticky top-0 self-start h-full">
          <div className="bg-white rounded-xl shadow-md p-4 md:p-6 border border-gray-100">
            <h3 className="text-lg font-bold text-indigo-700 mb-4 uppercase tracking-wide">Privacy Policy</h3>
        ...
        <main className="md:w-3/4 bg-white rounded-xl shadow-md p-6 md:p-10 border border-gray-100">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-2 text-gray-900">Privacy Policy</h1>
          <p className="text-center text-gray-500 mb-8 font-medium">Last Updated: 7th April, 2025</p>
          {/* Intro */}
          <div className="mb-8 text-gray-800 leading-relaxed">
            <p>
              Welcome to Daksh Call Karigar’s privacy policy (“Privacy Policy” or “Policy”).
              {/* Daksh Call Karigar Limited (formerly known as  India Pvt. Ltd.) and its affiliates (collectively, “Daksh Call Karigar”, “we” or “us”) are engaged in the business of providing web-based solutions to facilitate connections between customers that seek specific services and service professionals that offer these services. This Policy outlines our practices in relation to the collection, storage, usage, processing, and disclosure of personal data that you have consented to to share with us when you access, use, or otherwise interact with our website available at https://www.urbancompany.com/ or mobile application ‘Daksh Call Karigar’ (collectively, “Platform”) or avail products or services that Daksh Call Karigar offers you on or through the Platform (collectively, the “Services”). In this Policy, the services offered to you by service professionals on or through the Platform are referred to as “Professional Services”. */}
            </p>
            <p className="mt-4">
              {/* At Daksh Call Karigar, we are committed to protecting your personal data and respecting your privacy. In order to provide you with access to the Services or the Professional Services, we have to collect and otherwise process certain data about you. This Policy explains how we process and use personal data about you. */}
            </p>
            <p className="mt-4">
              {/* Please note that unless specifically defined in this Policy, capitalised terms shall have the same meaning ascribed to them in our Terms and Conditions, available at https://www.urbancompany.com/terms (“Terms”). Please read this Policy in consonance with the Terms. */}
            </p>
            <p className="mt-4">
